...
print("🚀 【2330_TW TSMC 系統啟動】開始執行 WMA 擴展窗口時序驗證...")
...
formatted_df.to_csv('TSMC_wma_temporal_validation_summary.csv', index=False)
print("\n" + "="*60)
print("🎉 【大功告成】2330_TW WMA 時序驗證全部跑完！")
print("👉 成果報告已成功儲存至 -> '2330_TW_wma_temporal_validation_summary.csv'")
print("="*60)
