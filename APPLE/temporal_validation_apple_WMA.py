...
formatted_df.to_csv('AAPL_wma_temporal_validation_summary.csv', index=False)
print("\n" + "="*60)
print("🎉 【大功告成】AAPL WMA 時序驗證全部跑完！")
print("👉 成果報告已成功儲存至 -> 'AAPL_wma_temporal_validation_summary.csv'")
print("="*60)
