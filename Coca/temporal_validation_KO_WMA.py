...
print("🚀 【KO 系統啟動】開始執行 WMA 擴展窗口時序驗證...")
...
formatted_df.to_csv('KO_wma_temporal_validation_summary.csv', index=False)
print("\n" + "="*60)
print("🎉 【大功告成】KO WMA 時序驗證全部跑完！")
print("👉 成果報告已成功儲存至 -> 'KO_wma_temporal_validation_summary.csv'")
print("="*60)
